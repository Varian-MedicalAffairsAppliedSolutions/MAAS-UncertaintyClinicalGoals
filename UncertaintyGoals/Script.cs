...
namespace VMS.TPS
{
  public class Script
  {
    ...
    public void Execute(ScriptContext context)
    {
      ...
      // Display opening msg
      string msg = $"The current UncertaintyClinicalGoals application is provided AS IS as a non-clinical, research only tool in evaluation only. The current " +
      ...
      "Newer builds with future expiration dates can be found here: https://github.com/Varian-Innovation-Center/MAAS-ProtonUncertaintyClinicalGoals\n\n" +
